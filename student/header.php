                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="images/img.png" alt="">Student User
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="message_from_librarian.php" class="dropdown-toggle info-number" data-toggle="dropdown"
                               aria-expanded="false">
                                ...
                                <span class="badge bg-red" onclick="window.location='message_from_librarian.php'; "><?php echo $tot; ?></span>
                            </a>
